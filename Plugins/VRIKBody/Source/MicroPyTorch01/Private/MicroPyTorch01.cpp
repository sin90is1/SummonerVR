...
#define LOCTEXT_NAMESPACE "FMicroPyTorch01Module"

void FMicroPyTorch01Module::StartupModule()
{
...
void FMicroPyTorch01Module::ShutdownModule()
{
	if (WrapperDllHandle != NULL)
	{
#if PLATFORM_WINDOWS
...
IMPLEMENT_MODULE(FMicroPyTorch01Module, MicroPyTorch01)